...
export default function Sidebar() {
  const { sidebarOpen, toggleSidebar } = usePlaybackStore();
  ...
  if (!sidebarOpen) {
    return (
      <div style={{ width: 48, background: "#161b22", borderRight: "1px solid #30363d", display: "flex", flexDirection: "column", alignItems: "center", paddingTop: 8, flexShrink: 0 }}>
        <button onClick={toggleSidebar} style={{ background: "none", border: "none", color: "#8b949e", cursor: "pointer", fontSize: 18, padding: 8 }} title="Open sidebar">
          ☰
        </button>
      </div>
    );
  ...
  return (
    <div style={{ width: 260, background: "#161b22", borderRight: "1px solid #30363d", display: "flex", flexDirection: "column", flexShrink: 0 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", padding: "8px 12px", borderBottom: "1px solid #30363d" }}>
        ...
        <button onClick={toggleSidebar} style={{ background: "none", border: "none", color: "#8b949e", cursor: "pointer", fontSize: 14, padding: "2px 4px" }} title="Close sidebar">
          ✕
        </button>
      </div>
